<template>
  <div v-if="cartStore.visible"  class="cart-cont">
    ...
    <div class="cart-footer">
      ...
      <NuxtLink v-if="cartStore.count" to="/making_an_order" class="checkout_btn"  @click="cartStore.visible = false">Оформить заказ</NuxtLink>
      <button v-else="cartStore.count"  class="checkout_btn" disabled>Оформить заказ</button>
    </div>
  </div>
</template>
